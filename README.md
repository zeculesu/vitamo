...
Данный проект принадлежит @zeculesu и @elilcatness, поэтому копирование, распространение и использование в коммерческих целях допустимо только с нашего согласия.
